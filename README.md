...
## 项目基本结构
- [api-config.js]知乎api的基本路径,并定义为常量[API_ROOT]

- [api-resource.js]引入[API_ROOT],定义{apiZhihu}对象存放各个需要访问的知乎api,最后定义常量并使用concat()于       [api-config.js]中的基本路径组合为访问所需api全路径

- [api-index.js]引入[api-resource.js]中的api路径,定义各api的访问方法,通过axios查询取值
